<%@ Page Language="VB" AutoEventWireup="false" CodeFile="yönetimbilgi.aspx.vb" Inherits="yönetimbilgi" %>
  ...
  <tr>
    ...
    <td background="resim/giris.png">
      ...
      <tr>
        ...
        <td width="215" class="style8">Kullanıcı adı:</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="style10"></td>
        <td class="style10">Parola</td>
      </tr>
      <tr>
        <td colspan="2" class="style9">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="TextBox2" runat="server" BackColor="#FBFBFB" 
                BorderStyle="None" Width="204px" TextMode="Password"></asp:TextBox>
            &nbsp;</td>
        </tr>
      <tr>
